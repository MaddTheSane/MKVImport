...
static const MatroskaQT_Codec kMatroskaCodecIDs = {
	...
	{ "V_REAL/RV30", CodecMapping(@"RealVideo 8", kCMMediaType_Video, 'RV30') },
	{ "V_REAL/RV40", CodecMapping(@"RealVideo 9", kCMMediaType_Video, 'RV40') },
	{ "V_THEORA", CodecMapping(@"Theora") },
...
//	{ "V_MPEGI/ISO/VVC", CodecMapping(@"VVC") }, // Not in common use/not complete?
	...
	{ "A_VORBIS", CodecMapping(AudioFormatXiphVorbis) },
	...
	{ "A_WAVPACK4", CodecMapping(@"WavPack") },
	{ "A_REAL/14_4", CodecMapping(@"RealAudio 1") },
	{ "A_REAL/28_8", CodecMapping(@"RealAudio 2") },
	{ "A_REAL/COOK", CodecMapping(@"RealAudio Cook") },
	{ "A_REAL/SIPR", CodecMapping(@"Sipro Voice") },
	{ "A_REAL/RALF", CodecMapping(@"RealAudio Lossless") },
	{ "A_REAL/ATRC", CodecMapping(@"ATRAC3") },
	...
	{ "A_ATRAC/AT1", CodecMapping(@"ATRAC1") },
	{ "A_MLP", CodecMapping(@"MLP (DVD-Audio)") },
	
	// subtitles:
#if 0
	{ "S_IMAGE/BMP", CodecMapping(kBMPCodecType) },
#endif
	{ "S_TEXT/USF", CodecMapping(@"Universal Subtitle", kCMMediaType_Subtitle, 'usf ') },
	{ "S_TEXT/SSA", CodecMapping(kSubFormatSSA) },
	{ "S_SSA", CodecMapping(kSubFormatSSA) },
	{ "S_TEXT/ASS", CodecMapping(kSubFormatASS) },
	{ "S_ASS", CodecMapping(kSubFormatASS) },
	...
	{ "S_VOBSUB", CodecMapping(kSubFormatVobSub) },
	{ "S_DVBSUB", CodecMapping(@"DVB Subtitle") },
	{ "S_KATE", CodecMapping(@"Karaoke And Text Encapsulation") },
	{ "S_TEXT/WEBVTT", CodecMapping(@"WebVTT", kCMMediaType_Subtitle, kCMSubtitleFormatType_WebVTT) },
	{ "S_HDMV/PGS", CodecMapping(@"HDMV PGS") },
